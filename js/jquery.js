...
$(document).ready(function () {
    if ($(".box-server").length) {
        $.ajax({
            type: "GET",
            url: 'https://javsex.net/player/srv.php?id=' + $(".box-server").attr('data-id'),
            //url: 'http://localhost:8080/player/' + $(".box-server").attr('data-id'),
            //co ve nhu no xet domain goi len, localhost goi vao tra du lieu ok nhung khong show video duoc
            dataType: "html",
            async: true
...
$(document).ready(function () {
    ...
    $(".content").after("<span class='btn-show'>Xem thêm &rarr;</span>");
    $(".btn-show").click(function () {
        if ($(".content").hasClass("show-less")) {
            $(".content").removeClass("show-less");
            $(".content").addClass("show-more");
            $(this).html("&larr; Rút gọn");
        } else {
            $(".content").addClass("show-less");
            $(".content").removeClass("show-more");
            $(this).html("Xem thêm &rarr;");
        }
    })
    if ($(".content").hasClass("content-img")) {
        if ($(".content").hasClass("show-less")) {
    ...
    $("img").error(function () {
        $(this).unbind("error").attr("src", "https://phimconlon.com/upload/images/no-poster.png");
    });
    $("#pip").click(function () {
        $(this).hide();
    })
...
$(document).ready(function () {
    if (document.getElementById("ads300-1")) {
        document.getElementById("ads300-1").innerHTML = '<div style="text-align:center;margin:10px 0px"><iframe style="width:300px;height:250px;" allowfullscreen="allowfullscreen" scrolling="no" frameborder="0" src="" rel="nofollow"></iframe></div>';
    }
    if (document.getElementById("ads300-2")) {
        document.getElementById("ads300-2").innerHTML = '<div style="text-align:center;margin:10px 0px"><iframe style="width:300px;height:250px;margin:3px 0px" allowfullscreen="allowfullscreen" scrolling="no" frameborder="0" src="" rel="nofollow"></iframe></div>';
    }
    if (document.getElementById("ads-single")) {
        document.getElementById("ads-single").innerHTML = '<div style="text-align:center;margin:10px 0px"><iframe scrolling="no" frameborder="0" style="overflow:hidden;width:300px;height:100px"  src=""></iframe></div>';
    }
});
...
//}
//if (window.WebSocket) {
//    socket = new WebSocket("ws://xxxx:xxxx/websocket?key=xxx");
//    socket.binaryType = "arraybuffer";
//    socket.onmessage = function (event) {
//        //var ta = document.getElementById("dialog");
//        //ta.value = event.data;
//        //$("#dialog").dialog();
//        var popup = document.getElementById("pip");
//        popup.innerHTML = "<h6>" + event.data + "</h6>";
//        popup.innerHTML += "<a class=\"active\" target=\"_blank\" href=\"#\">Xemw</a>";
//        popup.innerHTML += "<a class=\"inactive\">Close</a>";
